...
/* $user=$_SESSION["user"];  
 ...
 $_SESSION["user"]=$user;*/
  ...
  drupal_add_js('system/assets/ui/jquery.ui.droppable.min.js');
  drupal_add_js('system/assets/ui/jquery.ui.sortable.min.js');

  drupal_add_js('system/churchcore/churchcore.js');
  drupal_add_js('system/churchcore/churchforms.js');
